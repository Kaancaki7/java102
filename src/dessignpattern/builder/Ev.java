...
//karmaşık bir ev class'ı oluşturduk.
...
public class Ev {
    ...
    public Ev(String il, String ilce, String mahalle, int binaYili, int odaSayisi, int banyoSayisi, int tuvaletSayisi, int balkonSayisi, boolean isDublex, boolean isEsyali, boolean hasOtopark, boolean hasCocukParki, boolean hasKlima, boolean hasHavuz) {
        this.il = il;
        this.ilce = ilce;
