...
public class BBank implements IBank{
    ...
    BBank(String bankName,String terminalID,String password){
    ...
    public void connect() {
        ...
        System.out.println("Machine Ip: " + this.hostBIpAdress);
    }

    @Override
    public void cardInfo(double amount,String cardNo,String expDate,String cvc) {
        System.out.println("B Bank : transaction succesful");
    }
